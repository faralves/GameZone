...
namespace GameZone.WebAPI.Core.Usuario
{
    public class AspNetUser : IAspNetUser
    {
        ...
        public void AtualizarSessaoNomeUsuario(string nomeUsuario)
        {
            if (EstaAutenticado())
                _accessor.HttpContext.Session.SetString("SessionNome", nomeUsuario);
        }
